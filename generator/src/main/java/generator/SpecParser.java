...
public class SpecParser extends DefaultHandler {
    ...
    private static final String TEMPLATE_DIRECTORY = "generator/src/main/resources";
    ...
    private void generateTypeClass() throws IOException, TemplateException {
        ...
        generateInternal("Type.tmpl", "java-amqp-client/src/generated/java/com/amentra/amqp/client/Type.java", typeRoot);
    }
    ...
    private void generateStructs() throws IOException, TemplateException {
        ...
        for (StructDefinition sd : structs) {
            ...
            generateInternal(structTemplate, "java-amqp-client/src/generated/java/com/amentra/amqp/client/protocol/" + sd.getClassName() + ".java", structRoot);
        }
    }
    ...
    private void generateProxies() throws IOException, TemplateException {
        ...
        for (String className : classes) {
            ...
            String outputFileName = "java-amqp-client/src/generated/java/com/amentra/amqp/client/protocol/" + capitalizedClassName + "Proxy.java";
    ...
    private void generateMethodArguments(ClassDefinition classDefinition) throws IOException, TemplateException {
        ...
        for (MethodDefinition method : classDefinition.methods) {
            ...
            String outputFileName = "java-amqp-client/src/generated/java/com/amentra/amqp/client/protocol/" + className + method.getArgumentsClassName() + ".java";
    ...
    private void generateSessionBase() throws IOException, TemplateException {
        ...
        generateInternal("SessionBase.tmpl", "java-amqp-client/src/generated/java/com/amentra/amqp/client/SessionBase.java", templateData);
    }
    ...
    private void generateMethodArgumentsFactory() throws IOException, TemplateException {
        ...
        Map<String, Object> templateData = new HashMap<String, Object>();
        templateData.put("classDefinitions", classDefinitions);
        generateInternal("MethodArgumentsFactory.tmpl", "java-amqp-client/src/generated/java/com/amentra/amqp/client/MethodArgumentsFactory.java", templateData);
    }
    ...
    private void generateStructFactory() throws IOException, TemplateException {
        ...
        Map<String, Object> templateData = new HashMap<String, Object>();
        templateData.put("classDefinitions", classDefinitions);
        generateInternal("StructFactory.tmpl", "java-amqp-client/src/generated/java/com/amentra/amqp/client/StructFactory.java", templateData);
    }
    ...
    private void generateEnums() throws IOException, TemplateException {
    	for (String domain : enums.keySet()) {
			...
			generateInternal("Enum.tmpl", "java-amqp-client/src/generated/java/com/amentra/amqp/client/" + className + ".java", templateData);
		}
    }
	...
	public void execute() throws SAXException, IOException, ParserConfigurationException, TemplateException {
		...
		File f = new File("java-amqp-client/src/generated/java/com/amentra/amqp/client/");
		f.mkdirs();
		
		f = new File("java-amqp-client/src/generated/java/com/amentra/amqp/client/protocol");
        f.mkdirs();
