...
import com.amentra.amqp.client.AMQPVersionFramer;
import com.amentra.amqp.client.AMQPVersionNegotiator;
import com.amentra.amqp.client.Assembly;
import com.amentra.amqp.client.Frame;
import com.amentra.amqp.client.MessageType;
import com.amentra.amqp.client.MethodArguments;
import com.amentra.amqp.client.MethodArgumentsFactory;
import com.amentra.amqp.client.ProtocolCallback;
import com.amentra.amqp.client.ProtocolMessage;
import com.amentra.amqp.client.Segment;
import com.amentra.amqp.client.Segment.Type;
import com.amentra.amqp.client.Struct;
import com.amentra.amqp.client.StructFactory;
import com.amentra.amqp.client.api.Connection;
import com.amentra.amqp.client.impl.SessionImpl.State;
import com.amentra.amqp.client.protocol.ConnectionOpenArguments;
import com.amentra.amqp.client.protocol.ConnectionOpenOkArguments;
import com.amentra.amqp.client.protocol.ConnectionProxy;
import com.amentra.amqp.client.protocol.ConnectionStartArguments;
import com.amentra.amqp.client.protocol.ConnectionStartOkArguments;
import com.amentra.amqp.client.protocol.ConnectionTuneArguments;
import com.amentra.amqp.client.protocol.ConnectionTuneOkArguments;
import com.amentra.amqp.client.protocol.Header;
import com.amentra.amqp.client.protocol.MessageProxy;
import com.amentra.amqp.client.protocol.SessionAttachArguments;
import com.amentra.amqp.client.protocol.SessionAttachedArguments;
import com.amentra.amqp.client.protocol.SessionCommandPointArguments;
